...
export const metadata: Metadata = {
  ...
  description: "Contact Falcon Services in Karimnagar. Call +91 8179725035 or visit us at Ramnagar Signal Center.",
};
      ...
      <section className="py-14">
        <div className="container mx-auto grid gap-8 px-4 lg:grid-cols-[1fr_1.2fr]">
          <div className="space-y-4">
            ...
            <BookNowButton size="lg" className="w-full font-bold">
              Book a Service
            </BookNowButton>
          </div>
