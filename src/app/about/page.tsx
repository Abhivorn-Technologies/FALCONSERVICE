...
const teamImg = "/about-team.jpg";

export const metadata: Metadata = {
  title: "About Us — Falcon Services Karimnagar",
  description: "Falcon Services is Karimnagar's trusted home appliance repair team — 10+ years of experience and 25,000+ happy customers.",
};
