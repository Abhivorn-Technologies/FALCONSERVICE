...
import fridge from "@/assets/service-fridge.jpg";
import washing from "@/assets/service-washing.jpg";
import ac from "@/assets/service-ac.jpg";
import microwave from "@/assets/service-microwave.jpg";
  ...
  head: () => ({
    meta: [
      { title: "Services — Falcon Services Karimnagar" },
      {
        name: "description",
        content:
          "Refrigerator, Washing Machine, AC and Microwave repair services at your doorstep in Karimnagar.",
      },
    ],
  }),
});
