...
const amcImg = "/amc-hero.jpg";

export const metadata: Metadata = {
  title: "AMC Plans — Falcon Services Karimnagar",
  description: "Annual Maintenance Contract plans for refrigerators, washing machines, AC and microwaves. Priority service and discounts up to 20%.",
};
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {plans.map((p) => (
              ...
              >
                ...
                <BookNowButton className="mt-6 w-full font-semibold" variant={p.featured ? "default" : "outline"}>
                  Choose Plan
                </BookNowButton>
              </div>
            ))}
